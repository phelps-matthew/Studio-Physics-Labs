...
NotebookDataLength[     86607,       1756]
NotebookOptionsPosition[     58824,       1175]
NotebookOutlinePosition[     85286,       1739]
CellTagsIndexPosition[     85175,       1733]
WindowTitle->The Damped Nonlinear Pendulum
WindowFrame->Normal*)
...
Cell["The Damped Nonlinear Pendulum", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`plottype$$ = "stream", $CellContext`pt$$ = {
    1.25, -0.4}, $CellContext`tmax$$ = 15., $CellContext`\[Gamma]$$ = 
    0.3, $CellContext`\[Omega]0$$ = 0.9, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`\[Omega]0$$], 0.9, 
       "\!\(\*SubscriptBox[\(\[Omega]\), \(0\)]\)"}, -1., 1}, {{
       Hold[$CellContext`\[Gamma]$$], 0.3}, 0, 1}, {{
       Hold[$CellContext`pt$$], {1.25, -0.4}}, {-Pi, -1}, {Pi, 1}}, {{
       Hold[$CellContext`tmax$$], 15., "t"}, 1., 100.}, {{
       Hold[$CellContext`plottype$$], "stream", "plot type"}, {
      "stream", "density"}}}, Typeset`size$$ = {508., {123., 149.}}, 
    Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`\[Omega]0$8583$$ = 0, $CellContext`\[Gamma]$8584$$ = 
    0, $CellContext`pt$8585$$ = {0, 0}, $CellContext`tmax$8586$$ = 
    0, $CellContext`plottype$8587$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`plottype$$ = 
        "stream", $CellContext`pt$$ = {1.25, -0.4}, $CellContext`tmax$$ = 
        15., $CellContext`\[Gamma]$$ = 0.3, $CellContext`\[Omega]0$$ = 0.9}, 
      "ControllerVariables" :> {
        Hold[$CellContext`\[Omega]0$$, $CellContext`\[Omega]0$8583$$, 0], 
        Hold[$CellContext`\[Gamma]$$, $CellContext`\[Gamma]$8584$$, 0], 
        Hold[$CellContext`pt$$, $CellContext`pt$8585$$, {0, 0}], 
        Hold[$CellContext`tmax$$, $CellContext`tmax$8586$$, 0], 
        Hold[$CellContext`plottype$$, $CellContext`plottype$8587$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`\[Theta]$, $CellContext`t$, $CellContext`sol$}, \
...
\[Omega]0$$^2 Sin[
             ...
             0, $CellContext`\[Theta]$[0] == Part[$CellContext`pt$$, 1], 
             Derivative[1][$CellContext`\[Theta]$][0] == 
             Part[$CellContext`pt$$, 
               2]}, $CellContext`\[Theta]$, {$CellContext`t$, 
             0, $CellContext`tmax$$}], 1]; Labeled[
          Grid[{{
             Show[
              
              If[$CellContext`plottype$$ == "stream", StreamPlot, 
               StreamDensityPlot][{$CellContext`y, \
(-$CellContext`\[Omega]0$$^2) 
                 Sin[$CellContext`x] - $CellContext`\[Gamma]$$ \
$CellContext`y}, {$CellContext`x, -Pi, Pi}, {$CellContext`y, -1, 1}, 
              ...
              Quiet[
               ParametricPlot[
                Evaluate[
                 ReplaceAll[{
                   Mod[
                    $CellContext`\[Theta]$[$CellContext`t$], 2 Pi, -Pi], 
                   Derivative[
                   1][$CellContext`\[Theta]$][$CellContext`t$]}, \
$CellContext`sol$]], {$CellContext`t$, 0, $CellContext`tmax$$}, AspectRatio -> 
                1, PlotRange -> {{-Pi, Pi}, {-1, 1}}, Frame -> True, 
                PlotStyle -> Red, Exclusions -> {Evaluate[
                    Abs[
                    Mod[
                    ReplaceAll[
                    $CellContext`\[Theta]$[$CellContext`t$], \
$CellContext`sol$], 2 Pi]]] == Pi}, PerformanceGoal -> 
                ControlActive["Speed", "Quality"]]], 
              FrameTicks -> {{{-Pi, -Pi}, {(-Pi)/2, "-\[Pi]/2"}, {0, 0}, {
                 Pi/2, "\[Pi]/2"}, {Pi, Pi}}, Automatic, None, None}, 
              LabelStyle -> Directive["Italic", 14], FrameLabel -> {{
                 Row[{"\[Theta]'(", 
                   Style["t", Italic], ")"}], None}, {
                 Row[{"\[Theta](", 
                   Style["t", Italic], ")"}], None}}, 
               ...
               Evaluate[
                Mod[
                 ReplaceAll[
                  ...
                  2 Pi, -Pi]], {$CellContext`t$, 0, $CellContext`tmax$$}, 
               PlotRange -> {{0, 100}, {-Pi, Pi}}, LabelStyle -> 
               Directive["Italic", 14], FrameLabel -> {{
                  Row[{"\[Theta](", 
                    Style["t", Italic], ")"}], None}, {
                  Style["t", Italic], None}}, AspectRatio -> 1, Frame -> True,
                ImageSize -> {250, 250}, PlotStyle -> Blue, 
               Exclusions -> {Evaluate[
                   Mod[
                    ReplaceAll[
                    $CellContext`\[Theta]$[$CellContext`t$], \
$CellContext`sol$], 2 Pi, -Pi]] == 3.1, Evaluate[
                   Mod[
                    ReplaceAll[
                    $CellContext`\[Theta]$[$CellContext`t$], \
$CellContext`sol$], 2 Pi, -Pi]] == -3.1}, 
               FrameTicks -> {
                Automatic, {{-Pi, -Pi}, {(-Pi)/2, "-\[Pi]/2"}, {0, 0}, {
                  Pi/2, "\[Pi]/2"}, {Pi, Pi}}, None, None}, Epilog -> Inset[
                 Graphics[{
                   Line[{{0, 0}, 
                    ReplaceAll[{
                    Cos[$CellContext`\[Theta]$[$CellContext`tmax$$] - Pi/2], 
                    
                    Sin[$CellContext`\[Theta]$[$CellContext`tmax$$] - Pi/
                    2]}, $CellContext`sol$]}], Blue, 
                   Point[{0, 0}], Red, 
                   Point[
                    ReplaceAll[{
                    Cos[$CellContext`\[Theta]$[$CellContext`tmax$$] - Pi/2], 
                    ...
                    Sin[$CellContext`\[Theta]$[$CellContext`tmax$$] - Pi/
                    2]}, $CellContext`sol$]]}, PlotRange -> 1.2, Frame -> 
                  True, FrameTicks -> None], 
                 Scaled[{0.86, 0.85}], Automatic, {30, 30}]]]}}], 
          Text[
           Row[{"\[Theta](0) = ", 
             NumberForm[
              Part[$CellContext`pt$$, 1], {3, 2}], "   \[Theta]'(0) = ", 
             NumberForm[
              Part[$CellContext`pt$$, 2], {3, 2}]}]], Top, LabelStyle -> 
          Directive[Bold, 14]]], 
      "Specifications" :> {{{$CellContext`\[Omega]0$$, 0.9, 
          "\!\(\*SubscriptBox[\(\[Omega]\), \(0\)]\)"}, -1., 1, Appearance -> 
         "Labeled"}, {{$CellContext`\[Gamma]$$, 0.3}, 0, 1, Appearance -> 
         "Labeled"}, {{$CellContext`pt$$, {1.25, -0.4}}, {-Pi, -1}, {Pi, 1}, 
         ControlType -> Locator}, {{$CellContext`tmax$$, 15., "t"}, 1., 100., 
         Appearance -> 
         "Labeled"}, {{$CellContext`plottype$$, "stream", "plot type"}, {
         "stream", "density"}}}, "Options" :> {SynchronousUpdating -> False}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{559., {222., 228.}},
...
Cell[TextData[{
 "The plots show the motion of a harmonic oscillator with damping, in phase \
space on the left and as a function of time on the right, with the position \
of the pendulum in the top-right corner. The equation of motion is ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{
     ...
     RowBox[{
      SuperscriptBox[
       SubscriptBox["\[Omega]", "0"], "2"], " ", "sin", " ", 
      RowBox[{"\[Theta]", "(", "t", ")"}]}]}], "\[LongEqual]", "0"}], 
   TraditionalForm]], "InlineMath"],
 ", where ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["\[Omega]", "0"], TraditionalForm]], "InlineMath"],
 " is the natural frequency and ",
 Cell[BoxData[
  FormBox["\[Gamma]", TraditionalForm]], "InlineMath"],
 " is the damping constant. This equation does not take the form of the usual \
approximation ",
 Cell[BoxData[
  FormBox[
   RowBox[{
...
Cell["\<\
The second-order equation can be solved by splitting it into two first-order \
equations.\
\>", "ManipulateCaption",
 CellID->730884624],
...
Cell[TextData[{
 ButtonBox["Damped Simple Harmonic Motion",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/DampedSimpleHarmonicMotion.html"], None},
  ButtonNote->
...
Cell[TextData[{
 ButtonBox["Damped Simple Harmonic Motion--Underdamping",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/DampedSimpleHarmonicMotionUnderdamping.\
html"], None},
  ButtonNote->
   "http://mathworld.wolfram.com/DampedSimpleHarmonicMotionUnderdamping.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Damped Simple Harmonic Motion--Critical Damping",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/\
DampedSimpleHarmonicMotionCriticalDamping.html"], None},
  ButtonNote->
   "http://mathworld.wolfram.com/DampedSimpleHarmonicMotionCriticalDamping.\
html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
...
Cell[TextData[{
 ButtonBox["Damped Simple Harmonic Motion--Overdamping",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/DampedSimpleHarmonicMotionOverdamping.\
html"], None},
  ButtonNote->
...
TheDampedNonlinearPendulum&version=0007"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/TheDampedNonlinearPendulum/\
TheDampedNonlinearPendulum-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["The Damped Nonlinear Pendulum",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TheDampedNonlinearPendulum/"], 
    None},
  ButtonNote->"http://demonstrations.wolfram.com/TheDampedNonlinearPendulum/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/TheDampedNonlinearPendulum/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TheDampedNonlinearPendulum/"], 
    None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[45134, 809, 258, 7, 70, "ManipulateCaption",ExpressionUUID->"0e1bd0fe-a95a-461d-b655-2e2b6ba0aab2",
   CellTags->"ControlSuggestions"],
  Cell[45395, 818, 2587, 58, 70, "ManipulateCaption",ExpressionUUID->"73e96300-20d9-4703-aec8-0cd643c4144e",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[58002, 1150, 818, 23, 70, "Text",ExpressionUUID->"fd8feed4-2c7c-40d8-a174-fb9380544d82",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 84723, 1722},
 {"Copyright", 85028, 1727}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1531, 34, 34333, 568, 70, "DemonstrationHeader",ExpressionUUID->"76b14f06-08b3-4084-9979-cacfa43957b5"],
Cell[35867, 604, 50, 0, 70, "DemoTitle",ExpressionUUID->"b6a30057-3b35-4035-8d6f-95c69cb328be"],
Cell[35920, 606, 7670, 153, 70, "Output",ExpressionUUID->"0f7f6c4e-e84e-4274-a233-fd4c4ca4a69e",
 CellID->311390364],
Cell[43593, 761, 1262, 35, 70, "ManipulateCaption",ExpressionUUID->"44e3310c-20a5-42ee-ace2-0dae4c16bbbe"],
Cell[44858, 798, 124, 3, 70, "ManipulateCaption",ExpressionUUID->"ea77370e-0628-4463-8da2-7b8de11c839e",
 CellID->1359677114],
Cell[44985, 803, 146, 4, 70, "ManipulateCaption",ExpressionUUID->"5523fc9e-02a8-470f-ae91-29ece9b1515a",
 CellID->730884624],
Cell[45134, 809, 258, 7, 70, "ManipulateCaption",ExpressionUUID->"0e1bd0fe-a95a-461d-b655-2e2b6ba0aab2",
 CellTags->"ControlSuggestions"],
Cell[45395, 818, 2587, 58, 70, "ManipulateCaption",ExpressionUUID->"73e96300-20d9-4703-aec8-0cd643c4144e",
 CellTags->"ControlSuggestions"],
Cell[47985, 878, 44, 0, 70, "RelatedLinksSection",ExpressionUUID->"e937b542-9add-4885-9b63-e39229e6cc87"],
Cell[48032, 880, 537, 17, 70, "RelatedLinks",ExpressionUUID->"85070703-0177-4ac3-b041-ecd5d09a2b03",
 CellID->959133483],
Cell[48572, 899, 678, 22, 70, "RelatedLinks",ExpressionUUID->"340441ff-28de-485c-a98d-eb0ea31f81e6",
 CellID->1144194399],
Cell[49253, 923, 717, 23, 70, "RelatedLinks",ExpressionUUID->"ee9d1ec1-78de-48af-8821-afc03fc500f6",
 CellID->719767271],
Cell[49973, 948, 730, 24, 70, "RelatedLinks",ExpressionUUID->"4cd135f7-8be6-45e4-bfd4-33dad1604b7d",
 CellID->1714402927],
Cell[50706, 974, 717, 24, 70, "RelatedLinks",ExpressionUUID->"e59b8db3-1dea-4517-bcdb-d6f45432070d",
 CellID->1523413723],
Cell[51426, 1000, 529, 17, 70, "RelatedLinks",ExpressionUUID->"db3ef6e8-ea5e-4c6a-8176-901d03054bb7",
 CellID->1415921548],
Cell[51958, 1019, 4824, 90, 70, "DemoSourceNotebookSection",ExpressionUUID->"9b8c0321-f71b-4767-a194-2a48b63ac9d0",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[56785, 1111, 45, 0, 70, "CitationSection",ExpressionUUID->"7141cde8-0592-40f6-b862-1db0e80c2c3d"],
Cell[56833, 1113, 836, 23, 70, "Citations",ExpressionUUID->"6cb58a2f-d13c-41b3-9629-a6f0fc72d68c"],
Cell[57672, 1138, 327, 10, 70, "Author",ExpressionUUID->"2ecce91f-ad5b-4e36-9cf0-2644aaf18e53"],
Cell[58002, 1150, 818, 23, 70, "Text",ExpressionUUID->"fd8feed4-2c7c-40d8-a174-fb9380544d82",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature 1w0eC@G@SFW9dD1UmRLQWam5 *)
